...
WHERE cyclist_injured = 0 and cyclist_killed = 0 and pedestrians_injured=0 and pedestrians_killed=0 and vehicle_type_code_1 <> 'BICYCLE' and vehicle_type_code_2 <> 'BICYCLE' and temp_farenheit > 80
